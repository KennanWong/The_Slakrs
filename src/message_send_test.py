...
def test_send1():
    ...
    message_test = message_send(user1_tk,channel_id1,'testing')
...
def test_unauthorised():
    ...
    with pytest.raises(InputError):
        message_test = message_send(user2_tk, channel_id1,'testing')
